...
Answer:: I learnt how to use Express framework in Node for  (1) Routing (2) Middleware support 

- [x] Describe Middleware?

Answer:: Middleware allows one to create extra features and functions to our app  

- [x] Describe a Resource?

Answer:: Resource can call the endpoints we create so as to allow assess to our app

- [x] What can the API return to help clients know if a request was successful?

Answer:: The status code and other response taken care of by the developer

- [x] How can we partition our application into sub-applications?

Answer:: We can break it up into something called single pre....
